var table = '';
var file_name = "challan_table_4_out";
var pdf_title = "Challan Table 4 Out";
...
const page = {
    ...
    dataTable: function(){
        ...
        table = new DataTable("#example1", {
            ...
            ajax: {
                ...
                url: "ReportsController/challanTableOutView",
                type: "POST"
            },
        });
    ...
    serachParams: function(){
        ...
        var params = {supplier:supplier_search,date_range:date_range};
        return params;
    },
