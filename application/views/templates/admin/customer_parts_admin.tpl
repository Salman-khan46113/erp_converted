    ...
    <nav aria-label="breadcrumb">
      ...
      <div class="dt-top-btn d-grid gap-2 d-md-flex justify-content-md-end mb-5">
        <%if (checkGroupAccess("inhouse_parts_admin","export","No")) %>
          <button type="button" class="btn btn-seconday " data-bs-toggle="modal" data-bs-target="#importChildPartStock" title="Import Customer Parts"><i class="ti ti-upload"></i></button>
        <%/if%>
        <%if (checkGroupAccess("customer_parts_admin","export","No")) %>
        <a class="btn btn-seconday" href="<%base_url('export_parts_stock/customer')%>" target="_blank" title="Export Customer Parts"><i class="ti ti-download"></i></a>
