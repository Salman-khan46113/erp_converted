	...
	public function inwarding_details()
	{
		...
		public function inwarding_details_accept_reject()
		{
			...
			public function add_operations()
			{
				...
				if ($customer_count > 0) {
					$success = 0;
					$messages = "Operations  already Present.";
					...
					if ($insert) {
						$success = 1;
						$messages = "operations added successfully.";
					} else {
						$success = 0;
						$messages = "Something went wrong.";
					}
			...
			public function add_transporter()
			{
				...
				if ($insert) {
					$success = 1;
					$messages = "Transporter added successfully.";
				} else {
					$success = 0;
			...
			public function update_gst()
			{
				...
				if ($query) {
						...
						$success = 0;
						$messages = "Error While  Updating , Please try Again.";
											}
								...
								*/
								...
								public function final_inspection_qa()
								{
									...
									public function add_process_name()
									{
										...
										if ($inser_query) {
											$success = 1;
											$messages = " Process Added successfully.";
										} else {
											$success = 0;
